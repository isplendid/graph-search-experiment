...
import com.ibm.gse.index.test.TestDataStorageReader;
...
public class FileIndexService {
	...
	StorageReader dataReader;
	IDManager idman;
	PatternCodec codec;

	public FileIndexService(StorageReader dataReader) {
...
//					System.out.println("END FETCH ...");
	...
	public static void main(String[] args) {		
		FileIndexService is = new FileIndexService(new TestDataStorageReader());
