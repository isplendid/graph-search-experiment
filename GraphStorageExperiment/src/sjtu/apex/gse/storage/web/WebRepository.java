...
public class WebRepository implements Scan {
	...
	public WebRepository(QuerySchema sch, IDManager idman, SourceManager srcman) {
	...
	public WebRepository(QueryGraphNode sub, String pred, QueryGraphNode obj, IDManager idman, SourceManager srcman) {
