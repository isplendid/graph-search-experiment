...
public class TestFileIndexService {
	...
	public TestFileIndexService(StorageReader dataReader) {
...
//					System.out.println("END FETCH ...");
	...
	public static void main(String[] args) {		
		TestFileIndexService is = new TestFileIndexService(new TestDataStorageReader());
