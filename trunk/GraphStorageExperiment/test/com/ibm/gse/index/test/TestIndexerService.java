...
import com.ibm.gse.indexer.db.IndexStorage;
...
public class TestIndexerService {
	...
	TestDataStorageReader dataReader;
	PatternCodec codec;
	
    public TestIndexerService(IndexStorage indexstorage, TestDataStorageReader dsr) {
        try {
...
//   						System.out.println(sub + "\t" + obj);
	...
	public static void mainInsertNode() {
		...
		stg.uninstall();
		stg.install();
		TestIndexerService is = new TestIndexerService(stg, new TestDataStorageReader());
	...
	public static void mainInsertEdge(String filename) {
		TestIndexerService is = new TestIndexerService(new IndexStorage(), new TestDataStorageReader());
